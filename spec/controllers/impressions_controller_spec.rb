...
RSpec.describe ImpressionsController, :type => :controller do
  ...
  describe "GET show" do
    it "assigns the requested impression as @impression" do
      impression = Impression.create! valid_attributes
      get :show, {:id => impression.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested impression as @impression" do
      impression = Impression.create! valid_attributes
      get :edit, {:id => impression.to_param}, valid_session
      expect(assigns(:impression)).to eq(impression)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Impression" do
        expect {
          post :create, {:impression => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved impression as @impression" do
        post :create, {:impression => invalid_attributes}, valid_session
        expect(assigns(:impression)).to be_a_new(Impression)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested impression" do
        impression = Impression.create! valid_attributes
        put :update, {:id => impression.to_param, :impression => new_attributes}, valid_session
        impression.reload
      ...
      it "assigns the requested impression as @impression" do
        impression = Impression.create! valid_attributes
        put :update, {:id => impression.to_param, :impression => valid_attributes}, valid_session
        expect(assigns(:impression)).to eq(impression)
      end
    ...
    describe "with invalid params" do
      it "assigns the impression as @impression" do
        impression = Impression.create! valid_attributes
        put :update, {:id => impression.to_param, :impression => invalid_attributes}, valid_session
        expect(assigns(:impression)).to eq(impression)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested impression" do
      impression = Impression.create! valid_attributes
      expect {
        delete :destroy, {:id => impression.to_param}, valid_session
      }.to change(Impression, :count).by(-1)
    end
